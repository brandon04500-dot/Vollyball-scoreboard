...
function initializeCourtManager() {
    if (window.CourtManager) {
        ...
        courtManager = { generateStorageKey: () => 'volleyballScoreData_003' };
        courtInfo = { id: '003', name: '3구장' };
    }
}
...
function loadFromStorage() {
    try {
        const storageKey = courtManager ? courtManager.generateStorageKey() : 'volleyballScoreData_003';
...
function fetchServerData() {
    try {
        const courtId = courtManager ? courtManager.courtId : '003';
        ...
        ErrorHandler.logError('fetchServerData', error, { courtId: courtManager ? courtManager.courtId : '003' });
