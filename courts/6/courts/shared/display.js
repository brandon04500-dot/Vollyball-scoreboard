...
function initializeCourtManager() {
    if (window.CourtManager) {
        ...
        courtManager = { generateStorageKey: () => 'volleyballScoreData_006' };
        courtInfo = { id: '006', name: '6구장' };
    }
}
...
function loadFromStorage() {
    try {
        const storageKey = courtManager ? courtManager.generateStorageKey() : 'volleyballScoreData_006';
...
function fetchServerData() {
    try {
        const courtId = courtManager ? courtManager.courtId : '006';
        ...
        ErrorHandler.logError('fetchServerData', error, { courtId: courtManager ? courtManager.courtId : '006' });
