...
function initializeCourtManager() {
    if (window.CourtManager) {
        ...
        courtManager = { generateStorageKey: () => 'volleyballScoreData_008' };
...
function loadFromStorage() {
    try {
        const storageKey = courtManager ? courtManager.generateStorageKey() : 'volleyballScoreData_008';
...
function fetchServerData() {
    try {
        const courtId = courtManager ? courtManager.courtId : '008';
        ...
        ErrorHandler.logError('fetchServerData', error, { courtId: courtManager ? courtManager.courtId : '008' });
