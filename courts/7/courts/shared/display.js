...
function initializeCourtManager() {
    if (window.CourtManager) {
        ...
        courtManager = { generateStorageKey: () => 'volleyballScoreData_007' };
        courtInfo = { id: '007', name: '7구장' };
    }
}
...
function loadFromStorage() {
    try {
        const storageKey = courtManager ? courtManager.generateStorageKey() : 'volleyballScoreData_007';
...
function fetchServerData() {
    try {
        const courtId = courtManager ? courtManager.courtId : '007';
        ...
        ErrorHandler.logError('fetchServerData', error, { courtId: courtManager ? courtManager.courtId : '007' });
