...
function initializeCourtManager() {
    if (window.CourtManager) {
        ...
        courtManager = { generateStorageKey: () => 'volleyballScoreData_005' };
        courtInfo = { id: '005', name: '5구장' };
    }
}
...
function loadFromStorage() {
    try {
        const storageKey = courtManager ? courtManager.generateStorageKey() : 'volleyballScoreData_005';
...
function fetchServerData() {
    try {
        const courtId = courtManager ? courtManager.courtId : '005';
        ...
        ErrorHandler.logError('fetchServerData', error, { courtId: courtManager ? courtManager.courtId : '005' });
